...
import { ORDER_DELIVER_RESET, ORDER_PAY_RESET } from '../constant/orderConstants';
...
export default function OrderScreen() {
  ...
  const successHandlerPayment = (paymentResult) => {
    dispatch(payOrder(order, paymentResult))
  };
  const deliverHandler = () => {
    dispatch(deliverOrder(order._id))
    // TODO dispatch deliver action
  };
                    ...
                    {!sdkReady ? (
                      ...
                      <>
                        ...
                        <PayPalButton 
                          ...
                          onSuccess={successHandlerPayment}
                        ></PayPalButton>
                      </>
                    )}
                  </li>
